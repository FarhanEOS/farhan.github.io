...
<html lang="en">
  <head>
    ...
    <title>Andi Abdullah Bau Massepe</title>
    <!-- CSS saya -->
    <style>
      /* navbar */
      .navbar {
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      <img src="img/pahlawan2.png" alt="" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Andi Abdullah Bau Massepe</h1>
      <p class="lead">1918 - 2 Februari 1947</p>
    ...
    <section id="about">
      <div class="container text-center">
        <div class="row mb-3">
          <div class="col">
            <h2>Perjuangan Pahlawan Andi Abdullah Bau Massepe</h2>
        ...
        <div class="row justify-content-around fs-6 text-center">
          <div class="col-5">
            <p class="lead1kiri">
              Andi Abdullah Bau Massepe anggota Organisasi Politik Sudara (Sumber Daya Rakyat). September 1945 dalam menghadapi Indonesia Merdeka di Pare-Pare, Andi Abdullah Bau Massepe dan teman-temannya merubah Organisasi Sudara menjadi
              BPRI (Badan Penunjang Republik Indonesia) dan Andi sebagai Ketua Umum. Dadan ini sebagai pendukung Proklamasi dan sebagai wadah perjuangan mempertahankan proklamasi. Di Pare-Pare dibentuk KNI dipimpin Andi Abudllah Bau
              Massepe, KNI berubah menjadi PKRS (Pusat Keselamatan Rakyat Sementara). DR. Samratulangi, Gubernur Sulawesi Raya mendukungnya, juga Andi Abdullah Bau Massepe mendukung Pemerintah Republik Indonesia dan bersumpah setia di
              belakang Republik, KNI mengadakan rapat di pelosok membangkitkan semangat juang.
            </p>
          </div>
          <div class="col-5">
            <p class="lead1kanan">
              Andi Abdullah Bau Massepe memimpin perjuangan dalam bidang politik, dan militer dengan jalan memelihara keamanan, mengumpulkan senjata, membeli dan merampas senjata dari Jepang, menyusun strategi dan sabotase serta
              mengumpulkan pemuda untuk memutuskan jalan yang biasa dilalui Belanda. Serangan dimulai pada Januari 1946, dikirim kurir ke Jawa. Andi Abdullah Bau Massepe diangkat sebagai Kolonel Kehormatan oleh Presiden Soekarno dan minta
              dikirim senjata dari Jawa, hal ini tercium oleh Belanda maka Andi Abdullah Bau Massepe ditangkap oleh KNI. Pada bulan Agustus 1946 dipenjara selama 1 minggu. Andi Abdullah Bau Massepe ditembak pasukan Westerlaing, tanggal 2
              Februari 1947 sesudah ditahan 160 hari, ditangkap bulan Agustus 1946 dan wafat 10 hari sesudah Konferensi Patjekke.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="projects" id="projects" style="background-color: #666600">
      <div class="container">
        <div class="row text-center mb-4">
          <div class="col">
            <h2>Foto Tentang Pahlawan Andi Abdullah Bau Massepe</h2>
            <hr style="height: 4px; border-width: 0; color: rgb(0, 0, 0); background-color: rgb(0, 0, 0)" />
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-3">
            <div class="card">
              <img src="img/patungpahlawan2.png" class="card-img-top" alt="Pahlawan 2" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Patung yang dibuat untuk mengenang pahlawan Letnan Jendral Andi Abdullah Bau Massepe</p>
              </div>
            </div>
          </div>
        </div>
