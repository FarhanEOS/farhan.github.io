...
<html lang="en">
  <head>
    ...
    <title>Pajonga Daeng Ngalle</title>
    <!-- CSS saya -->
    <style>
      /* navbar */
      .navbar {
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      <img src="img/pahlawan8.png" alt="" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Pajonga Daeng Ngalle</h1>
      <p class="lead">1901 - 23 Februari 1958</p>
    ...
    <section id="about">
      <div class="container text-center">
        <div class="row mb-3">
          <div class="col">
            <h2>Perjuangan Pahlawan Pajonga Daeng Ngalle</h2>
        ...
        <div class="row justify-content-around fs-6 text-center">
          <div class="col-5">
            <p class="lead1kiri">
              Pada bulan Oktober 1945 bersama bangsawan lain seperti : (Andi Mappayuki) Bone, Andi Jemma dari Lawu, Andi Bau Massape (Sup pare-pare) Andi Pengeran Pellarani mengikuti konprensi raja-raja se-Sulawesi Selatan di Yogya,
              konprensi merumuskan satu resolusi mendukung pemerintah RI di Sulawesi sebagai satu-satunya pemerintah yang sah dibawah Gubernur Ratulangi. Raja Pajonga Daeng Ngalie mengumumkan polombangkeng sebagai wilayah De Fakto Negara
              RI, hal ini menunjukan Karaeng Pajonga sebagai seorang nasionalis.Menghadapi pemerintah Belanda yang ingin mengembalikan pemerintah jajahannya karaeng pajonga menjadikan plombangkeng sebagai pusat gerakan menggantikan posisi
              makasar yang pada saat itu sudah tidak aman, polombangkeng menjadi pusat bersatunya para tokoh pemuda perjuangan dari makassar, takalor, gowa, banteng.
            </p>
          </div>
          <div class="col-5">
            <p class="lead1kanan">
              Untuk mempertahankan proklamasi, Pajonga Daeng Ngalie membentuk Laskar Gerakan Muda Bajoang sebagai wadah perjuangan bersenjata yang diketuainya sendiri. Hal ini menunjukkan beliau memiliki karakter pejuang yang tidak mau
              kompromi dengan penjajah Belanda. Pada bulan Juli 1946 ketika Van Mook melakukan Konferensi Maleno untuk membentuk negara boneka Indonesia Timur (NIT), maka laskar lipan bajoang Pajonga Daeng Ngalle melaksanakan konferensi
              antar laskar se-Sulawesi Selatan, guna menyatukan, visi strategis dan kekuatan perjuangan yang hadir 19 laskar membentuk LAPRIS (Laskar Pemberontak Rakyat Indonesia Sulawesi) dengan panglimanya Ranggong Daeng Romo Sekretaris
    ...
    <section class="projects" id="projects" style="background-color: #ffcc33">
      <div class="container">
        <div class="row text-center mb-4">
          <div class="col">
            <h2>Foto Tentang Pahlawan Pajonga Daeng Ngalle</h2>
            <hr style="height: 4px; border-width: 0; color: rgb(0, 0, 0); background-color: rgb(0, 0, 0)" />
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-3">
            <div class="card">
              <img src="img/patungpahlawan8.png" class="card-img-top" alt="Pahlawan 8" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Patung yang dibuat untuk mengenang pahlawan Pajonga Daeng Ngalle</p>
              </div>
            </div>
          </div>
        </div>
