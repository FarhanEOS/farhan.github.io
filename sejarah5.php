...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .jumbotron {
        padding-top: 8rem;
        background-color: rgb(15, 191, 201);
        margin-top: -75px;
        overflow: hidden;
      }
      .jumbotron .display-4 {
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      <img src="img/sejarah5.png" alt="" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Serangan Umum Yogyakarta</h1>
      <p class="lead">1 Maret 1949</p>
    ...
    <section id="about">
      <div class="container text-center">
        <div class="row mb-3">
          <div class="col">
            <h2>Sejarah Serangan Umum Yogyakarta</h2>
        ...
        <div class="row justify-content-around fs-6 text-center">
          <div class="col-5">
            <p class="lead1kiri">
              Serangan umum 1 Maret 1949 merupakan sebuah respons atas Agresi Militer Belanda ke-II yang menjadikan Yogyakarta sebagai sasaran utamanya. Saat itu, Yogyakarta menjadi ibu kota Indonesia karena situasi di Jakarta tidak aman
              setelah proklamasi kemerdekaan Indonesia. Merespons serangan ini, militer Indonesia menunjukkan perlawanan di bawah komando Jenderal Soedirman, seperti dikutip dari berbagai sumber. Melalui serangan umum 1 Maret 1949, rakyat
              Indonesia ingin kembali menguasai ibu kota dan menunjukkan kepada dunia bahwa Indonesia masih eksis. Sirene keras berbunyi di segala penjuru kota pada pagi itu dan serangan mulai dilancarkan. Dalam penyerangan itu, Letkol
              Soeharto sebagai Komandan Brigade 10/Wehrkreise III langsung memimpin pasukan ke sektor barat sampai ke batas Malioboro. Sementara, sektor timur dipimpin oleh Venjte Sumual, sektor selatan dan timur dipimpin Mayor Sardjono,
              dan sektor utara oleh Mayor Kusno. Wilayah kota dipimpin oleh Letnan Amir Murtono dan Letnan Masduki. Akhirnya, pasukan militer Indonesia dan masyarakat yang turut bertempur berhasil menduduki Yogyakarta selama enam jam. Tepat
              pukul 12.00 WIB, mereka mundur ke front masing-masing.
            </p>
          </div>
          <div class="col-5">
            <p class="lead1kanan">
              Serangan Umum 1 Maret merupakan wujud kegelisahan rakyat Indonesia dan militer atas apa yang dilakukan oleh Belanda dan Sekutu. Mereka tak suka dengan sikap dari Belanda yang semena-mena dan mencoba masuk ke Indonesia.
              Padahal, sebelumnya telah dilakukan sejumlah kesepakatan. Saat ini Monumen Serangan Umum 1 Maret ini merupakan salah satu landmark dan cagar budaya Kota Yogyakarta sebagai bangunan yang mengingatkan tentang sejarah perjuangan
              bangsa Indonesia melawan penjajah pada masa lalu. Meskipun peristiwa Serangan Umum 1 Maret telah lama berlalu, sejarah tetap mencatatnya sebagai peristiwa bersejarah bangsa Indonesia.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="projects" id="projects" style="background-color: #ff0">
      <div class="container">
        <div class="row text-center mb-4">
          <div class="col">
            <h2>Foto Sejarah Serangan Umum Yogyakarta</h2>
            <hr style="height: 4px; border-width: 0; color: rgb(0, 0, 0); background-color: rgb(0, 0, 0)" />
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-3">
            <div class="card">
              <img src="img/fotosejarah5.png" class="card-img-top" alt="Sejarah 4" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Foto sejarah Serangan Umum di Yogyakarta.</p>
              </div>
            </div>
          </div>
          <div class="col-3">
            <div class="card">
              <img src="img/fotosejarah5s.png" class="card-img-top" alt="Sejarah 4" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Foto sejarah Serangan Umum di Yogyakarta.</p>
              </div>
            </div>
