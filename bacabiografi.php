      ...
      <div class="container">
        <div class="row text-center mb-4">
          <div class="col mb-3">
            ...
            <a href="#pahlawan" class="btn btn-light tombol1"><i class="bi bi-arrow-down-short"></i>Klik atau Scroll Untuk Melihat Konten Pahlawan<i class="bi bi-arrow-down-short"></i></a>
          </div>
        </div>
        <section id="pahlawan">
