...
<html lang="en">
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      <img src="img/pahlawan1.png" alt="" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Emmy Saelan</h1>
      <p class="lead">15 Oktober 1924 - 24 Januari 1947</p>
    ...
    <section id="about">
      <div class="container text-center">
        <div class="row mb-3">
          <div class="col">
            <h2>Perjuangan Pahlawan Emmy Saelan</h2>
        ...
        <div class="row justify-content-around fs-6 text-center">
          <div class="col-5">
            <p class="lead1kiri">
              Emmy Saelan sosok perawat dan pejuang yang berperan dalam mempertahankan kemerdekaan di Sulawesi Selatan. Pejuang muda alumni SMP Nasional Makassar sejak muda memperlihatkan sikap anti terhadap penjajah. Berperan dalam
              pemogokan “Stella Marris” sebagai bentuk protes terhadapap penangkapan Gubernur Sulawesi Sam Ratulangi. Tahun 1946 bergabung dengan Laskar Pemberontak Rakyat Indonesia Sulawesi (LAPRIS) dibawah komando Ranggong Daeng Romo.
              Pada agresi meliter Belanda kedua, Emmy Saelan menggabungkan diri padaLaskar Harimau Indonesia pimpinan Wolter Mongonsidi, beliau menjadi pimpinan Laskar Perempuan sekaligus petugas Palang Merah.
            </p>
          </div>
          <div class="col-5">
            <p class="lead1kanan">
              Perjuangannya berakhir setelah berhasil melemparkan granat pada pasukan Belanda di Kassi-Kassi pada tanggal 23 Januari 1947. Nasionalismedan patriotismenya mengilhami, berperan ganda sebagai perawat dan pejuang pada masa
              mempertahankan kemerdekaan Indonesia di Sulawasi Selatan. Metode yang digunakan dalam penelitian ini adalah penelitian sejarah dengan langkah-langkah sebagai berikut; heuristik, verifikasi, interpretasi dan historiografi.
              Penelitian ini bertujuan untuk mengungkap perjuangan Emmy Saelan mempertahankan kemerdekaan Indonesia di Sulawesi Selatan dalam perannya sebagai perawat sekaligus pejuang.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="projects" id="projects" style="background-color: #acac">
      <div class="container">
        <div class="row text-center mb-4">
          <div class="col">
            <h2>Foto Tentang Pahlawan Emmy Saelan</h2>
            <hr style="height: 4px; border-width: 0; color: rgb(0, 0, 0); background-color: rgb(0, 0, 0)" />
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-3">
            <div class="card">
              <img src="img/monumenpahlawan1.png" class="card-img-top" alt="Pahlawan 1" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Monumen Maha Putera Emmy Selain yang terletak di Jalan Hertasning Timur, Kelurahan Kassi-Kassi, Kecamatan Rappocini, Kota Makassar merupakan salah satu ruang publik yang bernilai sejarah.</p>
              </div>
            </div>
          </div>
          <div class="col-3">
            <div class="card">
              <img src="img/tamanpahlawan1.png" class="card-img-top" alt="Pahlawan 1" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Sulawesi Selatan mempunyai area hijau baru. Namanya Taman Emmy Saelan yang berlokasi di kawasan reklamasi Center Point of Indonesia (CPI). Taman ini secara resmi diluncurkan pada Sabtu (29/8/2020).</p>
              </div>
            </div>
          </div>
        </div>
