...
<html lang="en">
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      <img src="img/pahlawan20.png" alt="" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Sam Ratulangi</h1>
      <p class="lead">9 Juni 1920 – 3 Mei 2012</p>
    ...
    <section id="about">
      <div class="container text-center">
        <div class="row mb-3">
          <div class="col">
            <h2>Perjuangan Pahlawan Muhammad Yasin</h2>
        ...
        <div class="row justify-content-around fs-6 text-center">
          <div class="col-5">
            <p class="lead1kiri">
              Dia dikenal sebagai Bapak Brimob, atau kependekan dari Brigade Mobile. Sikapnya yang keras membuat sosoknya begitu dihormati oleh kawan dan ditakuti lawan. Pertempuran pertamanya dimulai saat menundukkan sebuah benteng Jepang
              di Semarang. Dengan penuh keberanian, dia menerobos tembakan peluru dan meminta agar balatentara Jepang menyerah kepada rakyat Indonesia.M Jasin dan pasukannya juga sangat berperan dalam pertempuran 10 November. Jasin juga
              yang berhasil menangkap Mayor Sabarudin yang bikin takut warga Surabaya dan sekitarnya karena sering bikin teror. Jasin merupakan satu dari sedikit perwira polisi yang dididik Marinir AS. Dia berjasa besar mengembangkan
              kepolisian dan membela kemerdekaan Pada 21 Agustus 1945, Inspektur Polisi Muhammad Yasin, Komandan Tokubetsu Keisatsutai (Polisi Istimewa) Surabaya, menyatakan bahwa Tokubetsu Keisatsutai Surabaya menjadi Kepolisian Negara
              Republik Indonesia dan segera melakukan tindakan-tindakan untuk mempertahankan kemerdekaan RI.
            </p>
          </div>
          <div class="col-5">
            <p class="lead1kanan">
              Sosok kelahiran Sulawesi ini menunjukkan semangat juang dan prestasi cemerlang ketika menjalan- kan tugas dari Kapolri Jenderal Raden Said Soekanto Tjokrodiatmodjo untuk membentuk Brigade Mobil. Saat itu, 1946, Muhammad Yasin
              menjabat Kepala Kepolisian di Karesidenan Malang. Kesatuan yang diresmikan pada 14 November 1946 di Purwokerto ini sejak awal berdirinya berjasa mengatasi ancaman keamanan dan ketertiban seperti pada peristiwa Agresi Militer
              Belanda dan APRA (Angkatan Perang Ratu Adil) di Bandung, serta peng- amanan jalan di wilayah Jawa Barat dari ancaman gerombolan DI/TII . Muhammad Jasin diangkat sebagai Bapak Brimob Kepolisian RI.Muhamamd Yasin menghembuskan
              nafas terakhir pada hari kamis tanggal 3 Mei 2012 pukul 15.30 WIB. Almarhum tutup usia dalam usia 92 tahun di RS Polri Kramat Jati. dan Almarhum dimakamkan di Taman Makam Pahlawan Kalibata.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="projects" id="projects" style="background-color: #5574ff">
      <div class="container">
        <div class="row text-center mb-4">
          <div class="col">
            <h2>Foto Tentang Pahlawan Muhammad Yasin</h2>
            <hr style="height: 4px; border-width: 0; color: rgb(0, 0, 0); background-color: rgb(0, 0, 0)" />
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-3">
            <div class="card">
              <img src="img/pahlawan20.png" class="card-img-top" alt="Pahlawan 16" width="100" height="250" />
              <div class="card-body">
                <p class="card-text">Foto pahlawan Muhammad Yasin</p>
              </div>
            </div>
          </div>
        </div>
